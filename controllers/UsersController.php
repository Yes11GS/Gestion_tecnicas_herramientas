...
/**
 * UsersController implementa las acciones de CRUD para el modelo de usuarios.
 */
class UsersController extends Controller
{
    ...
    public function behaviors()
    {
        return [
            'access' => [
                ...
                'only' => ['logout', 'user', 'admin','update','view','delete'],
                'rules' => [
                    [
                        //El administrador tiene permisos sobre las siguientes acciones
                        'actions' => ['logout', 'admin','update', 'view','delete'],
    ...
    /**
     * Enumera todos los modelos de usuarios.
     * @return mixed
     */
    ...
    /**
     * Muestra un solo modelo de usuarios.
     * @param integer $id
     * @return mixed
    ...
    /**
     * 
        Actualiza un modelo de usuarios existente.
    ...
    /**
     * Elimina un modelo de usuarios existente.
    ...
    /**
     *Encuentra el modelo de usuarios basado en su valor de clave principal.
